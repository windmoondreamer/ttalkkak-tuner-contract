...
enum Contract {
    ...
    static let sensOrder = ["gdz", "tdz", "gsat", "tsat", "fps", "moba", "desk", "gamma", "wasd", "debounce"]
    static let presetPrecision: [String: Int] = [
        "gdz": 2,
        "tdz": 2,
        "gsat": 2,
        "tsat": 2,
